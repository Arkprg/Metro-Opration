...
{
	public 
	partial class ManageReservReportForm : BaseForm
	{
		...
		[System.Diagnostics.DebuggerStepThrough()]private void InitializeComponent()
		{
			...
			this.HelpButtonClicked += new System.ComponentModel.CancelEventHandler(ManageReservReportForm_HelpButtonClicked);
			base.Load += new System.EventHandler(ManageReservReportForm_Load);
			...
			this.EndCalendar.TextAlignChanged += new System.EventHandler(this.StartCalendar_Enter);
			this.StartCalendar=new BPersianCalender.BPersianCalenderTextBox();
			this.StartCalendar.TextAlignChanged += new System.EventHandler(this.StartCalendar_Enter);
			...
			this.ExportButton.Location=new System.Drawing.Point(20, 21);
			...
			this.ShowGridView.Columns.AddRange(new DataGridViewColumn[] {this.Column12, this.Column1, this.Column3, this.Column11, this.Column10, this.Column7, this.Column8, this.Column2, this.Column5, this.Column6, this.Column4});
			...
			this.ShowGridView.Location=new System.Drawing.Point(12, 100);
			...
			this.ShowGridView.Size=new System.Drawing.Size(933, 450);
			this.ShowGridView.TabIndex=47;
			//
			//ShowButton
			//
			...
			this.ShowButton.Location=new System.Drawing.Point(156, 21);
			...
			//EndCalendar
			//
			this.EndCalendar.Location=new System.Drawing.Point(353, 46);
			...
			//StartCalendar
			//
			this.StartCalendar.Location=new System.Drawing.Point(353, 13);
			...
			this.ShiftCombo.Location=new System.Drawing.Point(583, 45);
			...
			this.LocalCombo.Location=new System.Drawing.Point(759, 12);
			...
			this.Label13.Location=new System.Drawing.Point(681, 49);
			...
			this.Label15.Location=new System.Drawing.Point(880, 16);
			...
			//Column8
			//
			this.Column8.HeaderText="نام شیفت";
			...
			//Column5
			//
			this.Column5.HeaderText="تعداد تریپ";
			...
			//Column6
			//
			this.Column6.HeaderText="ورود ثبت شده";
			...
			//Column4
			//
			this.Column4.HeaderText="خروج ثبت شده";
			this.Column4.Name="Column4";
			this.Column4.ReadOnly=true;
			//
			//ManageReservReportForm
			//
			...
			this.Name="ManageReservReportForm";
			this.RightToLeft=RightToLeft.Yes;
			this.ShowInTaskbar=false;
			this.StartPosition=FormStartPosition.CenterScreen;
			this.Text="گزارش مدیریتی راهبران رزرو";
